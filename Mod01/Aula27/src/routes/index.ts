...
router.get('/idade', (req: Request, res: Response) => { // No metodo get fica só a exibição da página
    res.render('pages/idade');
});
router.post('/idade-resultado', (req: Request, res: Response) => { // a rota fica no metodo post
